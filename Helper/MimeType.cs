...
namespace Automation
{
    public static class MimeType
    {
        ...
        public static String GetMimeType(String defaultMimeType)
        {
           
            string res = null;
            if (MimeTypeDict.ContainsValue(defaultMimeType))
            {
                foreach (string key in MimeTypeDict.Keys)
                {

                    if (MimeTypeDict[key] == defaultMimeType)
                        res = key;
                }
            }
